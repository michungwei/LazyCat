...
if($row){
	$type = $row["productserial_type_id"];
	$name = $row["productserial_name"];
	$pic = $row["productserial_pic"];
	$is_show = $row["productserial_is_show"];
	$create_time = $row["productserial_create_time"];
	$update_time = $row["productserial_update_time"];
}else{
 	script("資料不存在");
}
                    ...
                    <table width="850" border="0" cellpadding="0" cellspacing="3">
                        ...
                        <tr>
                            ...
                            <td><p>
                                    ...
                                    <br />
                                    (請上傳符合 <?php echo $productserial_pic_w; ?> x <?php echo $productserial_pic_h; ?> 尺寸的圖片)</p></td>
                        </tr>
                        <tr>
                            <td width="150"></td>
