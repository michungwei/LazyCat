...
$sql = "SELECT wish_id, wish_member_id, wish_product_id, wish_create_time, product_id, product_ind, product_sno, product_name_tw, product_name_en, product_pic1, member_id, member_account, member_name
		FROM $table_wish 
		LEFT JOIN $table_product ON wish_product_id = product_id 
		LEFT JOIN $table_member ON wish_member_id = member_id
		WHERE 1 $sql_str
		ORDER BY wish_member_id DESC, wish_create_time DESC";
...
<div id="mgbody-content">
    ...
    <div id="adminlist">
        <h2> <img src="../images/admintitle.png" />&nbsp;&nbsp;<?php echo $mtitle; ?> >&nbsp;&nbsp;WISHLIST清單</h2>
        <br>
        <form method="get" action="member_list.php">
            項目:
            <select name="type" id="type">
                <option value="" <?php echo ($type == "") ? "selected" : ""; ?>>不限</option>
				<option value="1" <?php echo ($type == "1") ? "selected" : ""; ?>>會員姓名</option>
        ...
        <div class="accordion">
            <table width="100%" cellspacing="0" class="list-table">
                <thead>
                    <tr>
                        <th width="150" align="center">會員姓名</th>
                        <th width="120" align="center">商品圖片</th>
                        <th align="left" >商品名稱</th>
                        <th width="150" align="center">選取日期</th>
                    </tr>
                </thead>
                <tbody id="the-list" class="list:cat">
					...
					?>
                    <tr>
                        <th align="center"><?php echo $row["member_name"]; ?></th>
