...
if($row){
	$pic = $row["banner_pic"];
	$pic_link = $row["banner_pic_link"];
	$is_show = $row["banner_is_show"];
	$create_time = $row["banner_create_time"];
	$update_time = $row["banner_update_time"];
}else{
 	script("資料不存在");
}
                ...
                <form action="edit_save.php?<?php echo $query_str; ?>" method="post" enctype="multipart/form-data" name="form" id="form">
                    ...
                    <table width="850" border="0" cellpadding="0" cellspacing="3">
                        <tr>
                            ...
                            <td rowspan="6" valign="top"><?php if($pic != ""){echo '<a href="'.$file_path.$pic.'" target="_blank"><img src="'.$file_path."m".$pic.'" width="100"></a>';} ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><p>
                                    ...
                                    <br />
                                    (請上傳符合 <?php echo $banner_pic_w; ?> x <?php echo $banner_pic_h; ?> 尺寸的圖片)</p></td>
                        </tr>
                        <tr>
